...
OpenAI-совместимый LLM-провайдер · 82 автотеста
...
Telegram-приём использует тот же токен, что и уведомления: один бот собирает
...
- [x] Фаза 6 — второй источник: Telegram-бот, собирающий заявку диалогом.
      Экзамен архитектуры: канал добавился тремя новыми файлами,
      `git diff` по остальным каталогам пуст
